...
Позволяет управлять командами и участниками, автоматически назначать ревьюверов на PR, выполнять переназначение и получать список PR'ов по конкретному пользователю.[file:94]
...
- Миграции применяются при старте сервиса из папки `migrations` в корне проекта.[file:94]
